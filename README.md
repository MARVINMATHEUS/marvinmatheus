...
### 🛠️ Tecnologias e Ferramentas (My Tools)
...
### 🌱 O que estou fazendo agora? (Currently working on)

* 🏗️ Construindo meu **Portfólio Profissional** utilizando Django e Angular.
* 🧠 Aprofundando estudos em **WebSockets** e **Arquitetura de Software**.
* ⚙️ Desenvolvendo projetos pessoais que integram lógica de negócios com interfaces modernas.
